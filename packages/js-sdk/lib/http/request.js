...
var KinveyHttpRequest = /** @class */ (function (_super) {
    ...
    KinveyHttpRequest.prototype.trace = function (value) {
        if (value) {
    ...
    KinveyHttpRequest.prototype.customRequestPropertes = function (properties) {
                    ...
                    case 5:
                        ...
                        refreshRequest = new KinveyHttpRequest({
                            ...
                            auth: function () { return __awaiter(_this, void 0, void 0, function () {
                                var credentials;
                                return __generator(this, function (_a) {
                                    credentials = js_base64_1.Base64.encode(micSession_1.client_id + ":" + init_1.getAppSecret());
