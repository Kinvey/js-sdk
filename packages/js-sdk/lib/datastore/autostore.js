...
var AutoStore = /** @class */ (function (_super) {
    ...
    AutoStore.prototype.pull = function (query, options) {
        return __awaiter(this, void 0, void 0, function () {
            var pullQuery, network, cache, queryCache, sync, count, queryCacheDoc, response, docs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3: return [4 /*yield*/, queryCache.findById(pullQuery.key)];
                    case 4:
                        queryCacheDoc = (_a.sent()) || { collectionName: this.collectionName, query: pullQuery.key, lastRequest: null };
                        return [4 /*yield*/, network.find(pullQuery, options)];
                    case 5:
                        response = _a.sent();
                        docs = response.data;
                        if (!pullQuery) return [3 /*break*/, 7];
                        return [4 /*yield*/, cache.remove(pullQuery)];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 9];
                    case 7: return [4 /*yield*/, cache.remove()];
                    case 8:
                        _a.sent();
                        _a.label = 9;
                    case 9: 
