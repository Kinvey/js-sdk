...
var DataStoreCache = /** @class */ (function (_super) {
    ...
    function DataStoreCache(collectionName, tag) {
        ...
        if (tag) {
            _this = _super.call(this, init_1.getAppKey(), collectionName + "." + tag) || this;
        }
        else {
            _this = _super.call(this, init_1.getAppKey(), collectionName) || this;
        }
        return _this;
    }
    ...
    DataStoreCache.prototype.save = function (docs) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!isArray_1.default(docs)) return [3 /*break*/, 2];
